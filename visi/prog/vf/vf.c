...
#ifdef HELP
LINE supm[] = {
{ 80, 0, 0, 0, LHDR, 0,0,0, "Настройка режимов" },
{  4, 2, 8, SUSNL,	INP|LVAR,	"%3d",	0,	tst_xy,	&yy },
{ 46, 2,16, 0, LTXT, 0,0,0, "yy/ количество пунктов (имен файлов) в столбце" },
{  4, 3, 8, SUSNL,	INP|LVAR,	"%3d",	0,	tst_xy,	&xx },
{ 23, 3,16, 0, LTXT, 0,0,0, "xx/ количество столбцов" },
{  4, 4, 8, SUSNL,	INP|LVAR,	"%3d",	0,	tst_xy,	&dx },
{ 56, 4,16, 0, LTXT, 0,0,0, "dx/ расстояние между первыми позициями соседних столбцов" },
{  4, 5, 8, SUSNL,	INP|LVAR,	"%3d",	0,	tst_xy,	&y0 },
{ 25, 5,16, 0, LTXT, 0,0,0, "y0/ позиция первой строки" },
{  4, 6, 8, SUSNL,	INP|LVAR,	"%3d",	0,	tst_xy,	&x0 },
{ 27, 6,16, 0, LTXT, 0,0,0, "x0/ позиция первого столбца" },
{ 45, 8, 8, 0, LHDR, 0,0,0, "смещение при переходе через границу кадра" },
{  4,10, 8, SUSNL,	INP|LVAR,	"%3d",	0,	tst_xy,	&ofsx },
{ 18,10,16, 0, LTXT, 0,0,0, "ofsx/ влево/вправо" },
{  4,11, 8, SUSNL,	INP|LVAR,	"%3d",	0,	tst_xy,	&ofsy },
{ 16,11,16, 0, LTXT, 0,0,0, "ofsy/ вверх/вниз" },
{ 58,13, 8, 0,	0|LTXT,	0,	cvt_hl,	0,	"-" },
{ 18,15, 8, 0, LTXT, 0,0,0, "количество пунктов" },
{  6,15,32, 0,	LVAR,	"%6d",	0,	0,	&itmmax },
{ 21,16, 8, 0, LTXT, 0,0,0, "курсором указан пункт" },
{  6,16,32, 0,	LVAR,	"%6d",	0,	0,	&itm },
{ 14,17, 8, 0, LTXT, 0,0,0, "смещение кадра" },
{  6,17,32, 0,	LVAR,	"%6d",	0,	0,	&itmofs },
{ 18,18, 8, 0, LTXT, 0,0,0, "макс. длина строки" },
{  6,18,32, 0,	LVAR,	"%6d",	0,	0,	&itmlen },
{ 0 }, };


LINE helpm[] = {
{ 80, 0, 0, 0, LHDR, 0,0,0, "Селектор имен файлов  VF (пробная версия)" },
...
{ 18,12, 8, 0, LTXT, 0,0,0, "cp `ls | vf` /tmp;" },
{ 33,12,32, 0, LTXT, 0,0,0, "копирование файлов в каталог /tmp" },
{ 19,13, 8, 0, LTXT, 0,0,0, "arrt xv1 `arrt t1`;" },
{ 44,13,32, 0, LTXT, 0,0,0, "чтение файлов с флоппи-диска в формате RT-11" },
{ 66,15, 1, 0, LTXT, 0,0,0, "Команда vf считывает стандартный ввод, отмеченные строки выдает на" },
{ 70,16, 1, 0, LTXT, 0,0,0, "стандартный вывод. Ввод/вывод можно перенаправлять (см. примеры выше)." },
{ 0 }, };
