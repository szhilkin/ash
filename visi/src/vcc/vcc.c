 ...
 * δΟΒΑΧΜΕΞ USRATTR Ι ÒΑΒΟΤΑ Σ ΞΙΝ.
 * 
...
des_hs( hp )
/*-----------------------*/
/* ΥΞΙήΤΟΦΙΤΨ ΛΥήΥ ΣΤÒΟΛ */
/*-----------------------*/
register HEAP *hp;
{
	free( hp->nmd );
	free( hp->top );        /* ΟΣΧΟΒΟΔΙΤΨ ΠΑΝΡΤΨ Χ ΟΒÒΑΤΞΟΝ ΠΟÒΡΔΛΕ */
}
